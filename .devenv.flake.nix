{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/fermuch/Documentos/Dev/AYVU/rs_protect";
  project_input_ref = "path:/home/fermuch/Documentos/Dev/AYVU/rs_protect";
  devenv_dotfile = "/home/fermuch/Documentos/Dev/AYVU/rs_protect/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-c48ba66";
  ...
  hostname = "nixos";
  username = "fermuch";
  git_root = "/home/fermuch/Documentos/Dev/AYVU/rs_protect";
  secretspec = null;
};
    in
    {
